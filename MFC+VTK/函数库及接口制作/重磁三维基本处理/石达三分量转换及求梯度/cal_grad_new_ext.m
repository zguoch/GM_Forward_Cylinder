function cal_grad_new_ext(str_open,DirRes,SavFor,para_xyz,ext_para)
%函数说明： 磁场梯度转换函数
%By KICIOLLO 
...
%           trans_xyz      参数，用以确定是进行哪种梯度变换，形式为[a b c]
%				a == 1     x方向导数
%               b == 1     y方向导数
%               c == 1     z方向导数
...
if para_xyz(3) == 1
	ZGrad(Mat,Dx,Dy,Per,ext_para);
	FulNamZG=[DirRes FilSep Nam '_ZGrad'];
	load dataZ;
