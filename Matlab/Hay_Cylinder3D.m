function [ Hay,x,y ] = Hay_Cylinder3D( Radius,Length,MagPar,CenterPosition,AxisRange,DXDY )
...
%         Hay(i,j)=u0/4/pi*(Mx*haxy+My*hayy+Mz*hayz);
ForwardPos=[x(j),y(i)];
[hay]=Hay_Cylinder3D_OnePoint(Radius,Length,MagPar,CenterPosition,ForwardPos);
 Hay(i,j)=hay;
